        ...
        try {
            ...
            try {
                ...
                if (sendersRes.ok && sendersJson) {
                    const aveniqSender = sendersJson.senders?.find((s) => s.email.toLowerCase() === "hello@theaveniq.site");
                    if (aveniqSender) {
            ...
            try {
                ...
                if (domainsRes.ok && domainsJson) {
                    const aveniqDomain = domainsJson.domains?.find((d) => d.domain.toLowerCase() === "theaveniq.in");
                    if (aveniqDomain) {
