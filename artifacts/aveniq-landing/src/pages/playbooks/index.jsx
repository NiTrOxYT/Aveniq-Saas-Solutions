...
export default function PlaybooksPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Actionable Engineering & Implementation Playbooks | Aveniq" description="Explore Aveniq's engineering playbooks for Enterprise AI Implementation, Startup MVP Execution, Cloud Migration, and API Design." canonical="https://theaveniq.site/playbooks"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Actionable Engineering & Delivery Playbooks" subtitle="Comprehensive, step-by-step execution playbooks created by Aveniq delivery leads and cloud architects." category="Execution Frameworks" author="Delivery Leadership Guild" reviewer="VP of Client Services" lastUpdated="August 2026" version="v1.6.0"/>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {playbooks.map((pb, idx) => (<Link key={idx} href={pb.href} className="group p-6 rounded-2xl bg-zinc-950 border border-white/10 hover:border-[#9C89D9]/50 transition-all duration-300 flex flex-col justify-between">
              <div>
