        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }} className="w-full max-w-sm bg-[#0e0e11] border border-[#1a1a22] rounded-xl p-8 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.9)]">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input type="email" id="login-email" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} className="w-full bg-[#08080a] border border-[#1a1a22] rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#10b981] text-white placeholder:text-white/20 text-xs font-light transition-colors" placeholder="operator@theaveniq.in" required/>
            </div>
