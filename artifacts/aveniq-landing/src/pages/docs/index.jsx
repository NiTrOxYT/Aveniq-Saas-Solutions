...
export default function DocsPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Public Engineering Documentation & Architecture Specs | Aveniq" description="Public technical documentation for AI agent state machines, Model Context Protocol (MCP), enterprise RAG, multi-tenant SaaS architecture, and CI/CD pipelines." canonical="https://theaveniq.site/docs"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Public Engineering Documentation & System Specs" subtitle="In-depth implementation guides, architectural specifications, and code patterns curated by Aveniq enterprise software architects." category="Developer Documentation" author="Aveniq Architecture Guild" reviewer="VP of Engineering" lastUpdated="August 2026" version="v3.0.0"/>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {docSections.map((doc, idx) => (<Link key={idx} href={doc.href} className="group p-6 rounded-2xl bg-zinc-950 border border-white/10 hover:border-[#9C89D9]/50 transition-all duration-300 flex flex-col justify-between">
              <div>
