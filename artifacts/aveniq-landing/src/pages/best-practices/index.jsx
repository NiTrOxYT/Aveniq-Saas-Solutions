...
export default function BestPracticesPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Engineering Best Practices & Code Standards | Aveniq" description="Review Aveniq's internal software engineering standards, code review checklists, testing coverage requirements, and deployment protocols." canonical="https://theaveniq.site/best-practices"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Engineering Standards & Quality Guidelines" subtitle="Our internal code quality checklists, pull request protocols, testing matrices, and observability benchmarks." category="Engineering Quality" author="Quality & Standards Guild" reviewer="VP of Engineering" lastUpdated="August 2026" version="v2.0.0"/>

        <div className="space-y-6 mb-16">
          {standards.map((item, idx) => (<div key={idx} className="p-6 rounded-2xl bg-zinc-950 border border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
