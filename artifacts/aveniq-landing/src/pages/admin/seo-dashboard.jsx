...
import { CheckCircle2, RefreshCw, Shield, FileText, Search, Activity } from "lucide-react";
export default function SEODashboardPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="SEO & Content Intelligence Dashboard | Aveniq Admin" description="Internal monitoring dashboard for tracking content review schedules, schema coverage, Core Web Vitals, and topical authority health."/>
      <Navbar />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs font-mono border-collapse">
              ...
              <tbody className="divide-y divide-white/5 text-white/80">
                {auditItems.map((item, idx) => (<tr key={idx} className="hover:bg-white/[0.02]">
