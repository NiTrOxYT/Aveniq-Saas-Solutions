...
const projectSchema = z.object({
  ...
  imageUrl: z
    .string()
    .trim()
    .min(1, "Please provide a preview image URL or upload an image.")
          ...
          <div className="bg-[#0e0e11] border border-[#1a1a22] rounded-xl p-6 w-full max-w-md relative z-10 space-y-4 shadow-2xl">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-[9px] font-semibold uppercase tracking-wider text-[#a1a1aa] mb-1 font-mono">Live Link / Preview Link</label>
                  <input name="link" type="text" defaultValue={editingProject.link || ""} placeholder="https://www.theaveniq.site/qr-menu" className="w-full bg-[#08080a] border border-[#1a1a22] rounded-lg px-3 py-2 text-white" />
                </div>
              </div>
              <div>
                <label className="block text-[9px] font-semibold uppercase tracking-wider text-[#a1a1aa] mb-1 font-mono">Image URL / Preview Image Link</label>
                <input name="imageUrl" type="text" defaultValue={editingProject.imageUrl || ""} required placeholder="https://res.cloudinary.com/... or image link" className="w-full bg-[#08080a] border border-[#1a1a22] rounded-lg px-3 py-2 text-white" />
              </div>
                    ...
                    <div className="bg-[#0e0e11] border border-[#1a1a22] rounded-xl p-6 space-y-6">
                      ...
                      <form onSubmit={handleAddProject} className="space-y-4 text-xs">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <label htmlFor="link" className="block text-[9px] font-semibold uppercase tracking-wider text-[#a1a1aa] mb-2 font-mono">
                              Live Link / Preview Link (Optional)
                            </label>
                            <input
                              type="text"
                              id="link"
                              ...
                              className="w-full bg-[#08080a] border border-[#1a1a22] rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#10b981] text-white font-light text-xs"
                              placeholder="https://www.theaveniq.site/qr-menu or /qr-menu"
                            />
                            <span className="block mt-1 text-[9px] text-[#a1a1aa]/60 font-mono">
                              e.g. https://www.theaveniq.site/qr-menu or /qr-menu
                            </span>
                          </div>
                        </div>

                        {/* Image / Preview selection mode */}
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1 p-0.5 rounded bg-[#08080a] border border-[#1a1a22]">
                              <button
                                ...
                                className={`px-2.5 py-0.5 rounded text-[10px] font-mono font-medium transition-colors cursor-pointer ${
                                  imageInputMode === "url"
                            ...
                            <div className="space-y-2">
                              <div className="flex gap-2">
                                <input
                                  ...
                                  className="w-full bg-[#08080a] border border-[#1a1a22] rounded-lg px-4 py-2.5 focus:outline-none focus:border-[#10b981] text-white font-light text-xs"
                                  placeholder="Paste image URL (e.g. Cloudinary, Unsplash, CDN)"
                                />
                                {imageUrl.trim() && (
                                  <button
                                    type="button"
                                    onClick={() => setImageUrl("")}
                                    className="px-3 py-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] text-[#a1a1aa] hover:text-white text-xs cursor-pointer border border-[#1a1a22]"
                                  >
                                    Clear
                                  </button>
                                )}
                              </div>
                              <p className="text-[9px] text-[#a1a1aa]/70 font-mono">
                                Paste any hosted image URL (Cloudinary, Supabase, Unsplash, or CDN).
                              </p>

                              {imageUrl.trim() && (
                                <div className="relative group w-full max-h-[120px] rounded-lg overflow-hidden flex items-center justify-center bg-black/60 border border-[#1a1a22] p-1">
                                  <img
                                    src={imageUrl.trim()}
                                    alt="Preview"
