...
export default function ProcurementPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Enterprise Procurement & Vendor Security Hub | Aveniq" description="Enterprise procurement support, vendor security questionnaires, SLA commitments, technical capability statements, and disaster recovery blueprints." canonical="https://theaveniq.site/procurement"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Enterprise Procurement & Security Hub" subtitle="Pre-verified vendor evaluations, security questionnaires, SLA agreements, and technical capability statements for enterprise buyers." category="Procurement Resources" author="Legal & Compliance Team" reviewer="Chief Information Security Officer" lastUpdated="August 2026" version="v1.9.0"/>

        <div className="space-y-6 mb-16">
          {documents.map((doc, idx) => (<div key={idx} className="p-6 sm:p-8 rounded-2xl bg-zinc-950 border border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
              ...
              <Link href="/contact" className="shrink-0 py-2.5 px-5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-semibold text-white flex items-center gap-2 transition-colors">
