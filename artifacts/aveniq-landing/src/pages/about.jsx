...
export default function AboutPage() {
    ...
    return (<div className="relative bg-black min-h-screen text-white selection:bg-[#6750A4] selection:text-white overflow-x-hidden">
      <SEOHead title="About Our Agency & Engineering Philosophy | Aveniq" description="Aveniq is a premier software engineering agency building multi-tenant SaaS platforms, custom AI architectures, RAG pipelines, and high-performance digital systems." canonical="https://theaveniq.site/about" keywords="About Aveniq, software engineering agency, senior developers, custom SaaS architects, AI automation engineers, software delivery model"/>
      ...
      <section className="relative min-h-[90dvh] flex flex-col items-center justify-center pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <div className="absolute inset-0" style={{
            background: "radial-gradient(ellipse 65% 55% at 50% 35%, rgba(103,80,164,0.1) 0%, transparent 70%)",
        }}/>
        </div>
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <motion.h1 initial={reduce ? false : { opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.23, 1, 0.32, 1] }} className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tight leading-[1.1] mb-10 max-w-5xl mx-auto" style={{ letterSpacing: "-0.03em" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => navigate("/start-project")} className="bg-[#f5f5f5] text-black px-8 py-3.5 rounded-full font-semibold text-sm transition-all duration-200 active:scale-[0.97] hover:brightness-110 flex items-center gap-2 cursor-pointer">
              Partner With Us
              <ArrowRight className="w-4 h-4"/>
            </button>
            <button onClick={() => navigate("/trust/engineering-standards")} className="px-8 py-3.5 rounded-full text-white/70 hover:text-white border border-white/[0.1] hover:border-white/[0.25] text-sm font-semibold transition-all duration-300 active:scale-[0.97] cursor-pointer">
              Read Our Standards
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06] rounded-2xl overflow-hidden border border-white/[0.06] grid-flow-row-dense">
            ...
            <div className="p-8 md:p-10 bg-[#09090b] flex flex-col justify-between md:col-span-2 min-h-[300px]">
              ...
              <button onClick={() => navigate("/architecture")} className="text-xs font-semibold text-[#9C89D9] hover:text-white transition-colors duration-300 flex items-center gap-1.5 mt-8 w-fit">
            ...
            <div className="p-8 md:p-10 bg-[#09090b] flex flex-col justify-between min-h-[300px]">
              ...
              <button onClick={() => navigate("/trust/engineering-standards")} className="text-xs font-semibold text-[#9C89D9] hover:text-white transition-colors duration-300 flex items-center gap-1.5 mt-8 w-fit">
            ...
            <div className="p-8 md:p-10 bg-[#09090b] flex flex-col justify-between min-h-[300px]">
              ...
              <button onClick={() => navigate("/docs")} className="text-xs font-semibold text-[#9C89D9] hover:text-white transition-colors duration-300 flex items-center gap-1.5 mt-8 w-fit">
            ...
            <div className="p-8 md:p-10 bg-[#09090b] flex flex-col justify-between md:col-span-2 min-h-[300px]">
              ...
              <button onClick={() => navigate("/trust/security-policy")} className="text-xs font-semibold text-[#9C89D9] hover:text-white transition-colors duration-300 flex items-center gap-1.5 mt-8 w-fit">
      ...
      <section className="py-32 px-6 relative z-10 border-t border-white/[0.04] text-center overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => navigate("/contact")} className="bg-[#f5f5f5] text-black px-8 py-3.5 rounded-full font-semibold text-sm transition-all duration-200 active:scale-[0.97] hover:brightness-110 cursor-pointer">
              Get In Touch
            </button>
            <button onClick={() => navigate("/tools/saas-cost-estimator")} className="px-8 py-3.5 rounded-full text-white/70 hover:text-white border border-white/[0.1] hover:border-white/[0.25] text-sm font-semibold transition-all duration-300 active:scale-[0.97] cursor-pointer">
