...
import { Layers, Cpu, Server, Database, Shield, ArrowUpRight, GitBranch } from "lucide-react";
...
export default function ArchitecturePage() {
  ...
  return (
    <div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead
        title="System Architecture Blueprint Library | Aveniq"
        description="Explore enterprise system architecture diagrams and blueprints for Multi-Tenant SaaS, Agentic AI, RAG pipelines, and Event-Driven Microservices."
        canonical="https://theaveniq.site/architecture"
      />
      <SchemaMarkup
        schema={[
          organizationSchema,
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader
          title="System Architecture Blueprint Library"
          subtitle="Battle-tested architectural blueprints, system topologies, tech stack selections, and trade-off analyses for enterprise software."
          category="Architecture Library"
          author="Principal Systems Architect"
          reviewer="VP of Technology"
        ...
        <div className="space-y-6 mb-16">
          {blueprints.map((blueprint, idx) => (
            <Link
              key={idx}
              href={blueprint.href}
              className="group p-6 sm:p-8 rounded-2xl bg-zinc-950 border border-white/10 hover:border-[#9C89D9]/50 transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6"
            >
