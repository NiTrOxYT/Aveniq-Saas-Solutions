...
import { Terminal, Code, Cpu, Github, ExternalLink, Box, ArrowUpRight } from "lucide-react";
...
export default function DevelopersPage() {
  ...
  return (
    <div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead
        title="Developer Hub & Open Source Ecosystem | Aveniq"
        description="Explore Aveniq's open source SDKs, Next.js SaaS boilerplates, Model Context Protocol (MCP) tools, and AI agent frameworks."
        canonical="https://theaveniq.site/developers"
      />
      <SchemaMarkup
        schema={[
          organizationSchema,
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader
          title="Developer Hub & Open Source Ecosystem"
          subtitle="Explore open source libraries, SDKs, enterprise boilerplates, and MCP integrations maintained by Aveniq engineers."
          category="Developer Community"
          author="Aveniq Open Source Team"
          reviewer="Head of Open Source"
