...
import { Code2, GitBranch, Zap, CheckCircle2 } from "lucide-react";
export default function EngineeringStandardsPage() {
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Engineering Standards & Software Quality | Aveniq" description="Learn about Aveniq's software architecture principles, automated testing rigor, CI/CD deployment pipelines, code review benchmarks, and SLA performance guarantees." canonical="https://theaveniq.site/trust/engineering-standards"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Engineering Standards & Code Quality" subtitle="Our engineering benchmarks: strict TypeScript type safety, modular microservices, automated unit & integration testing, zero-downtime deployment, and Core Web Vitals optimization." category="Engineering Rigor" author="Principal Software Architect" reviewer="VP of Engineering" lastUpdated="August 2026" version="v2.2.0"/>
