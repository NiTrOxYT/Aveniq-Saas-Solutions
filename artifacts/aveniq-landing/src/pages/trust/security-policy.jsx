...
export default function SecurityPolicyPage() {
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Security & Data Protection Standards | Aveniq" description="Discover Aveniq's Secure Software Development Lifecycle (SDLC), OWASP-aligned coding practices, data encryption standards, and enterprise compliance framework." canonical="https://theaveniq.site/trust/security-policy"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Security & Data Protection Standards" subtitle="Our enterprise secure software development lifecycle (S-SDLC), zero-trust architecture principles, data encryption protocols, and OWASP compliance standards." category="Security & Trust" author="InfoSec & Engineering Team" reviewer="Chief Information Security Officer" lastUpdated="August 2026" version="v3.1.0"/>
