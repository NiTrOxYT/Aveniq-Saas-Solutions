...
import { ShieldCheck, CheckCircle2, FileText, Lock, Users, Code } from "lucide-react";

export default function EditorialPolicyPage() {
  return (
    <div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead
        title="Editorial Policy & Content Governance | Aveniq"
        description="Learn how Aveniq ensures technical accuracy, peer-reviewed engineering content, AI disclosure, and zero-spam quality standards across all publications."
        canonical="https://theaveniq.site/trust/editorial-policy"
      />
      <SchemaMarkup
        schema={[
          organizationSchema,
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader
          title="Editorial Policy & Content Governance"
          subtitle="Our strict commitment to technical accuracy, peer-reviewed engineering content, ethical AI disclosure, and zero marketing fluff."
          category="EEAT & Governance"
