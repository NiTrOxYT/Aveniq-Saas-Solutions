...
export default function AIRoiCalculatorPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="AI ROI & Automation Savings Calculator | Aveniq" description="Calculate potential annual cost savings, time saved, and first-year ROI from deploying custom AI agents, workflow automation, and RAG architectures in your enterprise." canonical="https://theaveniq.site/tools/ai-roi-calculator"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Interactive Enterprise AI ROI & Savings Calculator" subtitle="Model the projected financial impact, labor efficiency gains, and payback period of deploying custom AI agents and workflow automation in your organization." category="Interactive Tool" author="AI Engineering Team" reviewer="Head of Solutions Architecture" lastUpdated="August 2026" version="v2.0.0"/>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-2xl bg-zinc-950 border border-white/10 space-y-6">
            ...
            <div>
              ...
              <input type="range" min="5" max="500" step="5" value={teamSize} onChange={(e) => setTeamSize(Number(e.target.value))} className="w-full accent-[#9C89D9] cursor-pointer"/>
            </div>
            ...
            <div>
              ...
              <input type="range" min="25" max="250" step="5" value={hourlyRate} onChange={(e) => setHourlyRate(Number(e.target.value))} className="w-full accent-[#9C89D9] cursor-pointer"/>
            </div>
            ...
            <div>
              ...
              <input type="range" min="2" max="35" step="1" value={manualHoursPerWeek} onChange={(e) => setManualHoursPerWeek(Number(e.target.value))} className="w-full accent-[#9C89D9] cursor-pointer"/>
            </div>
            ...
            <div>
              ...
              <input type="range" min="10" max="90" step="5" value={automationPercent} onChange={(e) => setAutomationPercent(Number(e.target.value))} className="w-full accent-[#9C89D9] cursor-pointer"/>
            </div>
          </div>
