...
export default function IntegrationsPage() {
    ...
    return (<div className="bg-black min-h-screen text-white selection:bg-[#6750A4]">
      <SEOHead title="Public API & Cloud Integration Guides | Aveniq" description="Developer integration guides and code patterns for OpenAI, Claude, Gemini, Supabase, Stripe, AWS, and Firebase." canonical="https://theaveniq.site/integrations"/>
      <SchemaMarkup schema={[
            organizationSchema,
            {
      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <ContentMetaHeader title="Public API & Cloud Integration Specs" subtitle="Battle-tested code samples, authentication patterns, error retries, and performance tips for enterprise APIs." category="Integration Guides" author="API Engineering Team" reviewer="Head of Integrations" lastUpdated="August 2026" version="v2.1.0"/>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {integrations.map((item, idx) => (<Link key={idx} href={item.href} className="group p-6 rounded-2xl bg-zinc-950 border border-white/10 hover:border-[#9C89D9]/50 transition-all duration-300 flex flex-col justify-between">
              <div>
