      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {(() => {
            ...
            return (<HeaderTag {...headerProps} className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-6">
              ...
              <Link href="/portfolio" className="text-[#9C89D9] text-xs font-semibold uppercase tracking-wider flex items-center gap-2 hover:text-white transition-colors duration-300 shrink-0 cursor-pointer group">
                View All Projects 
