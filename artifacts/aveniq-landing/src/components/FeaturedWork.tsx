...
export default function FeaturedWork() {
  ...
  return (
    <section id="portfolio" className="py-32 px-6 relative z-10 bg-black overflow-hidden border-t border-white/[0.03]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {(() => {
          ...
          return (
            <HeaderTag
              {...headerProps}
              className="flex flex-col md:flex-row items-start md:items-end justify-between mb-20 gap-6"
            >
              <div>
          ...
          {projects.map((proj, i) => {
            ...
            return (
              <CardDiv
                ...
                className={`${cardClass} ${hoverClass} cursor-pointer`}
              >
                  ...
                  <div className="relative w-full aspect-[1.7/1] md:aspect-auto md:flex-grow overflow-hidden bg-zinc-950">
                    {proj.imageUrl ? (
                      <LazyImage
                        ...
                        className="w-full h-full object-cover object-top filter contrast-[1.01] brightness-[0.98] transition-transform duration-700 ease-out-premium group-hover:scale-[1.01]"
                      />
                    ) : (
