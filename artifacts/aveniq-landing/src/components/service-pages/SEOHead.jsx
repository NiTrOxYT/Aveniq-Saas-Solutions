...
export function SEOHead({ service }) {
    useEffect(() => {
        ...
        const orgSchema = {
            ...
            description: "Aveniq is a premium software agency building SaaS platforms, AI automation systems, mobile apps, and custom software for startups and enterprises.",
            address: {
                "@type": "PostalAddress",
