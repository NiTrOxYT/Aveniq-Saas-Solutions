...
export function ProcessTimeline() {
    ...
    useEffect(() => {
        if (reduce || isMobile || !wrapRef.current || !trackRef.current)
            return;
    ...
    return (<section className="border-t border-white/[0.04] relative z-10">
      ...
      <div ref={wrapRef} className="relative overflow-hidden h-[100dvh]">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
            background: "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(103,80,164,0.04) 0%, transparent 70%)",
        }} aria-hidden="true"/>
        ...
        <div ref={trackRef} className="absolute top-0 left-0 flex h-full items-center" style={{ paddingLeft: "6vw", paddingRight: "6vw", gap: "24px" }}>
          {/* Progress line */}
          <div className="absolute top-1/2 -translate-y-1/2 h-[2px] pointer-events-none" style={{
            left: "6vw",
            width: `calc(100% - 12vw)`,
          ...
          {PROCESS_STEPS.map((step, i) => (<article key={step.phase} className="relative flex-shrink-0 w-[340px] md:w-[380px] p-8 rounded-2xl border border-white/[0.08] hover:border-white/[0.18] bg-white/[0.03] backdrop-blur-[20px] shadow-[0_30px_80px_rgba(0,0,0,0.35)] hover:-translate-y-1.5 transition-all duration-500 group overflow-hidden" style={{ height: "320px" }}>
              ...
              <div className="flex items-center gap-3 mb-6 relative z-10">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-mono font-bold text-[#9C89D9] group-hover:text-white transition-colors duration-500" style={{
              ...
              <h3 className="text-xl font-semibold text-white mb-4 tracking-tight relative z-10 group-hover:text-white transition-colors duration-300" style={{ fontFamily: "'Instrument Serif', serif" }}>
                {step.title}
              </h3>
