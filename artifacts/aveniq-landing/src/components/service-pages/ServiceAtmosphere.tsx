...
export function ServiceAtmosphere() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {!reduce && (
        <>
          <motion.div
            ...
            className="absolute top-[-25%] left-[-20%] w-[90vw] h-[90vw] rounded-full blur-[200px]"
            style={{
          ...
          <motion.div
            ...
            className="absolute bottom-[-15%] right-[-15%] w-[100vw] h-[100vw] rounded-full blur-[220px]"
            style={{
      ...
      <div 
        className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.015)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.015)_1px,transparent_1px)] bg-[size:48px_48px] pointer-events-none hidden md:block"
        style={{
