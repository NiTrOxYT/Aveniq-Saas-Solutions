...
export function IndustriesServed() {
    ...
    return (<section className="py-28 px-4 sm:px-6 relative z-10 border-t border-white/[0.04]">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
            background: "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(103,80,164,0.04) 0%, transparent 70%)",
        }} aria-hidden="true"/>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {INDUSTRIES.map((industry, i) => (<motion.div key={industry.name} initial={reduce ? false : { opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.15 }} transition={{
                duration: 0.5,
                delay: i * 0.07,
                ease: [0.23, 1, 0.32, 1],
