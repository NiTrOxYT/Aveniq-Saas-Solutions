          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-20">
              ...
              <button
                ...
                className="group relative px-12 py-4 rounded-full text-sm font-semibold text-white overflow-hidden active:scale-[0.97] transition-transform duration-200 flex items-center gap-2.5 shadow-lg shadow-black/30 cursor-pointer"
              >
                <div
