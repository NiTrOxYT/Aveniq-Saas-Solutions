      ...
      <div className="max-w-4xl mx-auto relative px-8 py-16 md:py-24 rounded-3xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-[20px] shadow-[0_30px_80px_rgba(0,0,0,0.35)] overflow-hidden group">
        ...
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 65% 55% at 50% 50%, rgba(139,92,246,0.15) 0%, rgba(0,0,0,0) 70%)",
            }}
          />
          {!reduce && (
            <motion.div
        ...
        <div className="relative z-10 text-center">
          ...
          >
            ...
            <p
              className="text-white/45 text-base md:text-lg font-light leading-relaxed mb-12 max-w-[55ch] mx-auto"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-20">
              ...
              <button
                ...
                className="group px-10 py-4 rounded-full text-sm font-semibold text-white/70 hover:text-white border border-white/[0.08] hover:border-white/[0.25] transition-all duration-300 flex items-center gap-2 active:scale-[0.97] cursor-pointer bg-white/[0.01] hover:bg-white/[0.03]"
              >
                Start Your Project
