  ...
  return (
    <section className="py-28 px-4 sm:px-6 relative z-10 border-t border-white/[0.04] bg-[#020202]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 60% at 10% 50%, rgba(103,80,164,0.04) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          <h2
            className="text-3xl md:text-5xl font-medium text-white mb-5 tracking-tight leading-tight animate-fade-in"
          ...
          {WHY_ITEMS.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon
                    className="w-4 h-4 text-[#9C89D9] group-hover:text-white transition-colors duration-300"
                    strokeWidth={1.5}
                  />
                </div>
