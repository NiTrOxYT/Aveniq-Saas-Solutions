      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 text-left">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://linkedin.com/in/sourik-aich-2b87a8241" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-white/60 hover:text-white transition-colors"><Linkedin className="w-4 h-4" /></a>
            <a href="https://github.com/NiTrOxYT" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-white/60 hover:text-white transition-colors"><Github className="w-4 h-4" /></a>
            ...
            <a href="https://instagram.com/_sourik.js" target="_blank" rel="noreferrer" aria-label="Instagram" className="text-white/60 hover:text-white transition-colors"><Instagram className="w-4 h-4" /></a>
          </div>
        </div>
      </div>
