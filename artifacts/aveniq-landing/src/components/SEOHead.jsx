...
export default function SEOHead({ title = "Aveniq — AI Software Development, Custom SaaS & Automation", description = "Aveniq is an enterprise AI software development company specializing in custom SaaS solutions, AI agents, RAG, workflow automation, and digital transformation.", canonical, ogType = "website", ogImage = "https://theaveniq.site/og-image.png", keywords = "AI development company, AI agents, custom SaaS development, enterprise software, workflow automation, RAG, MCP, Next.js, React, Node.js", }) {
    useEffect(() => {
        // Title
