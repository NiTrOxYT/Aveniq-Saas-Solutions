...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 bg-black pt-16 pb-10 px-6 border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto">
        
        {/* Conditional Footer CTA Block */}
        {showCTA && (
          <div className="mb-20 pb-16 border-b border-white/[0.04] text-center max-w-3xl mx-auto space-y-8">
            <h2 
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/start-project"
                className="w-full sm:w-auto bg-white hover:bg-white/90 text-black px-8 py-3.5 rounded-full font-bold text-xs transition-colors flex items-center justify-center gap-1.5"
              >
                Start Your Project <ArrowRight className="w-3.5 h-3.5" />
              </Link>
              <Link
                href="/contact"
                className="w-full sm:w-auto px-8 py-3.5 rounded-full border border-white/10 hover:border-white/20 text-white font-semibold text-xs transition-colors text-center"
              >
                Contact Us
              </Link>
            </div>
        ...
        {/* Footer Navigation Grid — 5 cols */}
          ...
          <div className="col-span-2 md:col-span-1 space-y-4">
            ...
            <div className="space-y-1 text-white/50 text-xs font-light">
              ...
              <p>Kolkata, India</p>
              <a href="mailto:hello@theaveniq.site" className="block hover:text-white transition-colors pt-1">hello@theaveniq.site</a>
            </div>
          </div>
